                ...
                <div class="card-body">
                    ...
                    <div class="mb-15 ml-17">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" value="{{old('admin_name')}}" name="admin_name">
                    ...
                    <div class="mb-3 ml-17">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <input name="email" type="email" class="form-control" placeholder="Enter required email"/>

...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form" action="{{route('admin.companies.edit',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 ml-17">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input name="email" type="email" class="form-control" value="{{$data->email}}" placeholder="Enter required email" required/>
                            ...
                            <div class="col-lg-6">
                                <div class="radio-inline">
                                    <label class="radio radio-success">
                                        <input type="radio" name="account_type" value="regular" {{$data->account_type == 'regular'?'checked':''}}/>
                                        <span></span>
                                        Regular
                                    </label>
                                    <label class="radio radio-success">
                                        <input type="radio" name="account_type" value="logistic" {{$data->account_type == 'logistic'?'checked':''}} />
                                        <span></span>
                                        Logistics
                                    </label>
                                </div>

...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form" action="{{route('admin.cdocuments.create')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="mb-15 ml-17">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 offset-1">
                                <input name="name" required value="{{old('name')}}" type="text" class="form-control" placeholder="Please Enter Document name"/>

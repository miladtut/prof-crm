...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form" action="{{route('admin.inquiry.customer-document.edit',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                            ...
                            <div class="checkbox-list">
                                @foreach(\App\Models\Customerdoc::all() as $doc)
                                    <label class="checkbox">
                                        <input type="checkbox" {{$data->customer_docs()->where('id',$doc->id)->count() > 0 ? 'checked':''}}  name="cdocs[]" value="{{$doc->id}}"/>
                                        <span></span>
                                        {{$doc->name}}
                                    </label>
                                @endforeach

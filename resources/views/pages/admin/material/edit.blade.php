...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form" action="{{route('admin.materials.edit',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="mb-15 ml-17">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <input name="name" required type="text" value="{{$data->name}}" class="form-control" placeholder="Please Enter country name"/>
                                ...
                                <div class="checkbox-inline">
                                    @foreach(\App\Models\Supplier::all() as $supplier)
                                        <label class="checkbox ml-5 w-70px">
                                            <input name="suppliers[]" type="checkbox" @if($data->suppliers()->where('id',$supplier->id)->count() > 0) checked @endif value="{{$supplier->id}}"/>
                                            <span></span>

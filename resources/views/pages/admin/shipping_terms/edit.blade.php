...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="form" action="{{route('admin.shipping.terms.edit',$data->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    ...
                    <div class="mb-15 ml-17">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3 offset-1">
                                <input name="shipping_name" required type="text" class="form-control" value="{{$data->shipping_name}}" placeholder="Please Enter country name"/>

        ...
        <div class="card-spacer mt-n25">
            ...
            <div class="row m-0">
                <div class="col bg-white px-6 py-8 rounded-xl mr-7">
                    <h1>{{\App\Models\Inquiry::where('status_name','declined')->count()}}</h1>
                    <h3 class="text-dark font-weight-bold">
                        Declined
                    </h3>
                </div>
                <div class="col bg-white px-6 py-8 rounded-xl">
                    <h1>{{\App\Models\Inquiry::where('status_name','closed')->count()}}</h1>
                    <h3 class="text-dark font-weight-bold">
                        Closed
                    </h3>
                </div>

            ...
            <table class="table table-borderless table-vertical-center">
                <thead>
                    <tr>
                        ...
                        <th class="p-0" style="width: 50px">type</th>
                        <th class="p-0" style="min-width: 200px">material</th>
                        <th class="p-0" style="min-width: 100px">customer</th>
                ...
                <tbody>
                @php($inquiries = \App\Models\Inquiry::latest()->limit(5)->get())
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">
                                @if($inquiry->material_name)
                                {{$inquiry->material_name}}
                                @elseif($inquiry->s_po)
                                {{$inquiry->s_po->material_name}}
                                @else
                                    {{'----'}}
                                @endif
                            </a>
                        ...
                        <td >
                            ...
                            @elseif(preg_match('#declined#',$inquiry->status_name))
                        ...
                        <td >
                            <a href="{{route('admin.inquiry.show',$inquiry->id)}}" class="btn btn-info btn-sm">
                                View Inquiry
                            </a>
                        </td>

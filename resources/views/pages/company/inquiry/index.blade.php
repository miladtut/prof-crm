    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">all Inquiries
                </h3>
            </div>
            <div class="card-toolbar">

                @if(auth()->user()->account_type == 'logistic')
                    <button class="btn btn-success font-weight-bolder" data-toggle="modal" data-target="#logModal">
                        New Inquiry
                    </button>
                @else
        ...
        <div class="card-body">
            ...
            <div class="mt-2 mb-5 mt-lg-5 mb-lg-10">
                <form action="{{route('company-inquiry-list')}}">

...
<div class="card card-custom {{ @$class }}">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            ...
            <span class="card-label font-weight-bolder text-dark">For <a href="{{route('admin.companies.show',$data->company_id)}}">{{$data->company_name}}</a></span>
    ...
    <div class="card-header border-0 pt-5 row">
            ...
            <div class="col-xl-6 mt-2">
                @if(auth('admin')->user()->super_admin == '1')
                    <a href="#" class="btn btn-light-info status details" >{{$data->status_name}}</a>
                @else
            ...
            <div class="col-xl-6 mt-2">
                ...
                @else
                    <a href="" class="btn btn-secondary payment details">mark paid</a>
                @endif
            </div>
    ...
    <div class="card-body pt-3 pb-0">
        <div class="row">
            <div class="col-12">
                @if($data->material)
                    <a href="{{route('admin.materials.edit',$data->material->id)}}">
        ...
        <div class="table-responsive">
            <table class="table table-borderless table-vertical-center">
                ...
                <tr>
                    ...
                    <td class="pl-0">
                        <div>
                            <span class="text-muted font-weight-bold text-hover-primary">COA file</span>
                        </div>
                    </td>
                    <td class="pl-0 text-left">
                        <b>
                            @if($coa)
                                <a href="{{route('admin.download',['path'=>$coa->name])}}" ><i class="fa fa-paperclip text-primary"></i> {{strtoupper(setName($coa->name,'COA Document'))}}</a>
                            @endif
                        </b>
                    </td>

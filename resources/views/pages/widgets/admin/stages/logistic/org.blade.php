        ...
        <div class="col-9">
            <div class="card card-custom {{ @$class }}">
                <div class="card-body pt-10 pb-10 text-center">
                    <h3>Please Upload The  original Documents</h3>
                    <form action="{{route('admin.org.send',[$data->id,'update'])}}" method="post" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group">
                                <h3 class="text-right">
                                    ...
                                    <a href="{{route('admin.download',['path'=>$file->name])}}">
                                        ...
                                        {{setName($file->name,'original_doc')}}
                                    </a>
                                    @endforeach
                                </h3>
                            </div>
        ...
        <div class="col-9">
            <div class="card card-custom {{ @$class }}">
                <div class="card-body pt-10 pb-10 text-center">
                    <h3>Please Upload The  original Documents</h3>
                    <div class="mt-3">
                        <form action="{{route('admin.org.send',$data->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" name="doc[]" class="custom-file-input" id="validatedCustomFile" multiple required>

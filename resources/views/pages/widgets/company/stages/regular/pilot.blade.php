        ...
        <div class="col-9">
            <div class="card card-custom {{ @$class }}">
                <div class="card-body pt-10 pb-10 text-center">
                    <h3>Your Pilot Request Of {{$data->pilot->qty}} {{$data->pilot->qty_unit}} Of {{$data->material_name}} Has Been Sent To Profect</h3>
...
@if($status == 'rejected')
    <?php
    $text = 'pilot price modify request';
    $status_class = 'danger';
    $txt_class= 'danger';
    ?>
    <div class="row my-t">
